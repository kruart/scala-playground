  ...
  val syncExerciseHandler: HttpRequest => HttpResponse = {
    case HttpRequest(HttpMethods.GET, Uri.Path("/"), _, _, _) =>
      HttpResponse(
        ...
        entity = HttpEntity(ContentTypes.`text/html(UTF-8)`, "Hello from the exercise front door!"))
    ...
    case request: HttpRequest =>
      ...
      HttpResponse(
        ...
        entity = HttpEntity(ContentTypes.`text/html(UTF-8)`, "OOPS, you're in no man's land, sorry.")
      )
  }
